...
export default function Contact(props) {
    ...
    return (
        <div class="grid text-center grid-cols-2 gap-4 place-items-center py-40">
            <div className="p-20">
                <h1 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-sky-400 to-red-600">
