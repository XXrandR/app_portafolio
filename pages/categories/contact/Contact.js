    ...
    return (
        <div>
            <div className="flex justify-center text-white pt-64" style={style}>
                <div>
                    <h1 class="text-4xl text-justify font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-sky-400 to-red-600 w-96">
            ...
            <form href="https://google.com">
            <div className="flex justify-center text-white h-80">
                <div>
                    <textarea className="resize rounded-md bg-black/70 p-2 focus:caret-indigo-500 text-inherit text-slate-500 h-72" styles={textarea} placeholder="Enter some text..."></textarea>
                </div>
                <div>
                    ...
                    <br />
                    <button className="rounded-md btn-styled m-4">Send Message</button>
                </div>
            </div>
            </form>
        </div>
